...
local function get_groups()
    ...
    local groups = {
        ...
        NormalNC = config.dim_inactive and { fg = colors.fg3, bg = colors.bg1 } or { link = "Normal" },
        ...
        -- Tree / file plugins (small but useful subset)
        ...
        NvimTreeSpecialFile = { fg = colors.yellow, bold = true, underline = config.underline },
        ...
        NeoTreeFloatBorder = { fg = colors.gray, bg = colors.bg1 },
        NeoTreeTitleBar = { fg = colors.fg1, bg = colors.bg2 },
        NeoTreeDirectoryIcon = { fg = colors.green },
        NeoTreeDirectoryName = { fg = colors.green, bold = config.bold },

        -- Minimal Mini.nvim integration (commonly useful pieces)
